...
[
  ['長袖トップス', '0', '良品です！', '66', 'M', 'ナイキ', '新品、未使用', '送料込み（出品者負担）', '北海道','2-3日', '1800', '1', '1',open("#{Rails.root}/db/fixtures/710858447.g_400-w_g.jpg"),'1','20200120','20200120',],
  ['レディースジャケット', '0', '良品です！', '64', 'M', '', '未使用に近い', '着払い（購入者負担）', '横浜','5日', '3200', '2', '1',open("#{Rails.root}/db/fixtures/161117-3-1a.jpg"),'2','20200120','20200120',],
  ['おすすめレディースジャケット', '0', '良品です！', '68', 'M', 'シャネル', '目立った傷や汚れなし', '送料込み（出品者負担）', '北海道','2-3日', '5600', '1', '1', open("#{Rails.root}/db/fixtures/428.jpg"), '3','20200120','20200120',],
  ['GUコーデ', '0', '良品です！', '221', 'M', '', 'やや傷や汚れあり', '着払い（購入者負担）', '青森','2-3日', '2600', '1', '1', open("#{Rails.root}/db/fixtures/20170715121414.jpg"), '4','20200120','20200120',],
  ['冬アウター', '0', '良品です！', '63', 'M', 'ナイキ', '傷や汚れあり', '送料込み（出品者負担）', '岩手','3年', '1300', '1', '1', open("#{Rails.root}/db/fixtures/imgrc0080352437.jpg"), '5','20200120','20200120',],
  ['お気に入りジャケット', '0', '良品です！', '67', 'M', 'シャネル', '全体的に状態が悪い', '着払い（購入者負担）', '秋田','1.5年', '4200', '1', '1', open("#{Rails.root}/db/fixtures/S2104101683037_01.jpg"), '6','20200120','20200120',],
  ['あったかジャケット', '0', '良品です！', '65', 'M', 'ナイキ', '新品、未使用', '送料込み（出品者負担）', '栃木','1日', '1400', '1', '1', open("#{Rails.root}/db/fixtures/61X7p8NKmuL._UX385_.jpg"), '7','20200120','20200120',],
  ['ジャケット', '0', '良品です！', '64', 'M', 'シャネル', '未使用に近い', '着払い（購入者負担）', '東京','5日', '2100', '1', '1', open("#{Rails.root}/db/fixtures/m17510377472_1.jpg"), '8','20200120','20200120',],
  ['セーター', '0', '良品です！', '68', 'M', 'ナイキ', '目立った傷や汚れなし', '送料込み（出品者負担）', '東京','5日', '6800', '1', '1', open("#{Rails.root}/db/fixtures/271063388.jpg"), '9','20200120','20200120',],
  ['アウター', '0', '良品です！', '69', 'M', 'シャネル', 'やや傷や汚れあり', '着払い（購入者負担）', '東京','5日', '2100', '1', '1', open("#{Rails.root}/db/fixtures/242982776.jpg"), '10','20200120','20200120',],
  ['ZARA アウター', '0', '良品です！', '221', 'M', '', '傷や汚れあり', '送料込み（出品者負担）', '東京','5日', '7000', '1', '1', open("#{Rails.root}/db/fixtures/m59740265111_1.jpg"), '11','20200120','20200120',],
  ['冬アウター', '0', '良品です！', '64', 'M', '', '全体的に状態が悪い', '着払い（購入者負担）', '岩手','3年', '1300', '1', '1', open("#{Rails.root}/db/fixtures/132464_r1.jpg"), '12','20200120','20200120',],
  ...
  ['ユニクロ あったかジャケット', '0', '良品です！', '64', 'M', '', '未使用に近い', '着払い（購入者負担）', '栃木','1日', '1400', '1', '1', open("#{Rails.root}/db/fixtures/61I1soBGxyL._SX342_.jpg"), '14','20200120','20200120',],
  ['テーラードジャケット', '0', '良品です！', '221', 'M', '', '目立った傷や汚れなし', '送料込み（出品者負担）', '東京','5日', '2100', '1', '1', open("#{Rails.root}/db/fixtures/9884_3b2.jpg"), '15','20200120','20200120',],
  ['カシミア ジャケット', '0', '良品です！', '64', 'M', '', 'やや傷や汚れあり', '着払い（購入者負担）', '東京','5日', '6800', '1', '1', open("#{Rails.root}/db/fixtures/61hzLuHxusL._UX679_.jpg"), '16','20200120','20200120',],
  ...
  ['おすすめレディースジャケット', '0', '良品です！', '64', 'M', '', '全体的に状態が悪い', '着払い（購入者負担）', '北海道','2-3日', '5600', '1', '1', open("#{Rails.root}/db/fixtures/71JsWQC3o9L._UX679_.jpg"), '18','20200120','20200120',],
